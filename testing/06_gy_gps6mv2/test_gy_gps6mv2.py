...
No motors are touched by this script.
"""
...
print("UART%d  tx=GP%d (pin 1)  rx=GP%d (pin 2)  %d baud"
...
if seen == 0:
    raise SystemExit(
        "\nNO DATA.\n"
        "  1. TX/RX are almost certainly swapped - GPS TX must go to Pico RX (GP%d, pin 2)\n"
